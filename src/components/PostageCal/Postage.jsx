...
//     // This ensures that the pincode options used for filtering are arrays
...
//     const article = domestic.articleType[articleType];
...
//                   {Object.keys(domestic.articleType).map(type => (
...
//             <Button variant="primary" onClick={handleSubmit} disabled={!articleType}>
//               Get Price
//             </Button>
//           </>
//         )}
...
//       {validationMessage && (
//         <Alert variant={validationMessage.startsWith('Form submitted') ? 'success' : 'danger'}>
//           {validationMessage}
//         </Alert>
//       )}
//     </Container>
